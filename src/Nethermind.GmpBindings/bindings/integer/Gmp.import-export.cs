...
public static partial class Gmp
{
    ...
    public static unsafe partial void mpz_import(in mpz_t rop, nuint count, int order, nuint size, int endian, nuint nails, void* op);
    ...
    public static unsafe partial void* mpz_export(void* rop, out nuint countp, int order, nuint size, int endian, nuint nails, in mpz_t op);
}
